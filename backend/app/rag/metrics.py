...
from app.services.retrieval import Retriever, RetrievedChunk
...
class InstrumentedRetriever:
    ...
    def __init__(self, retriever: Retriever, hit_threshold: float = _HIT_THRESHOLD) -> None:
        ...
        # Forward frequently-accessed attributes used by build_search_tool and SemanticCache.
        self.config = retriever.config
        self.embedder = retriever.embedder
        self.qdrant = retriever.qdrant
